...
SLACK_MESSAGE="{\"type\":\"mrkdwn\", \"text\":\"New version available (0.1.$CIRCLE_BUILD_NUM): \n\n*Mac:*\nhttps://physio-client-2.s3.eu-central-1.amazonaws.com/Physio+Client+2-0.1.$CIRCLE_BUILD_NUM-mac.zip\n\n*Windows:*
https://physio-client-2.s3.eu-central-1.amazonaws.com/Physio+Client+2+Setup+0.1.$CIRCLE_BUILD_NUM.exe\n\n*Linux:*\nhttps://physio-client-2.s3.eu-central-1.amazonaws.com/Physio+Client+2+0.1.$CIRCLE_BUILD_NUM.AppImage\"}"
